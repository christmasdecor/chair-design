...
function rand_ua($mobile=FALSE)
{
	...
	if($mobile)
	{
		/*$ua 	= file(__DIR__ . '/assets/mobile-ua.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
		shuffle($ua);
		return  $ua[0];*/
...
{	
	...
	{
		echo "\r\n[\033[31mWARNING\033[39m] ==> Article empty..\r\n";
	}
