...
@foreach($keywords as $id => $keyword)
	...
	<ns0:entry>
		...
		<ns0:title type="html">{{rand(11,35)}} {{do_spintax('{New|Trend|Aesthetic|Best|Awesome|}')}} {{ ucwords($keyword) }} For {{do_spintax('{Desktop Background|Android|Iphone|Ipad/Tablet|Windows Phone|Home Screen|Lock Screen}')}} With {{do_spintax('{Ultra HD|High Resolution|High Definition|Full Screen|Full HD|HD|1080P|1440P|2K|4K}')}} Quality</ns0:title>
